...
def get_args(arglist=None):
    ...
    parser.add_argument(
            '--mission', 
            type=str, 
            default='missions/spencerworld.xml', 
    ...
    parser.add_argument('--episodemaxsteps', type=int, default=64, help='max number of steps per episode')
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='whether or not it is a guided learner')
    parser.add_argument(
        '--explanations',
        action='store_true',
        default=False,
        help='whether or not to use explanations')
